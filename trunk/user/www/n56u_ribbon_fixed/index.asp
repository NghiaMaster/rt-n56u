...
function modem_html(device_seat, modem_order){
	...
	icon_html_code += '    <div id="iconModem'+modem_order+'" class="big-icons big-icons-mmc" onclick="clickEvent(this);"></div>\n';
	icon_html_code += '</a>\n';
...
<div class="wrapper">
    ...
    <div class="container-fluid" style="padding-right: 0px">
        <div class="row-fluid">
            <div class="span3"><center><div id="logo"></div><span style="color:#fff">RT-AC1200</span></center></div>
            <div class="span9" >
